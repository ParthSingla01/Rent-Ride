...
import { At as init_clsx, H as createTheme, Lt as init_generateUtilityClass, R as init_styleFunctionSx, Rt as generateUtilityClass, Ut as init_composeClasses, V as init_createTheme, Wt as composeClasses, at as handleBreakpoints, ct as resolveBreakpointValues, et as createUnarySpacing, kt as clsx, n as styled, nn as init_deepmerge, nt as init_spacing, ot as init_breakpoints, rn as deepmerge, st as mergeBreakpointsInOrder, t as init_styled, tt as getValue, z as extendSxProp } from "./styled-ViFiq-Ug.js";
...
import { b as styled$1, v as useThemeProps } from "./esm-IXmzNn18.js";
...
function createStack(options = {}) {
	...
	const Stack = /* @__PURE__ */ import_react.forwardRef(function Grid(inProps, ref) {
		...
		const { component = "div", direction = "column", spacing = 0, divider, children, className, useFlexGap = false } = props, other = _objectWithoutPropertiesLoose(props, _excluded);
...
//# sourceMappingURL=Stack-Dp2axLlU.js.map