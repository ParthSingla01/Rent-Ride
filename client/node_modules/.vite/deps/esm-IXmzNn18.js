...
import { $ as init_createSpacing, $t as getDisplayName, At as init_clsx, Ct as ThemeContext$1, Et as DefaultPropsProvider, G as styleFunctionSx, H as createTheme, J as init_sizing, Jt as resolveProps, Kt as init_resolveProps, Lt as init_generateUtilityClass, Mt as clamp, Qt as init_getDisplayName, R as init_styleFunctionSx, Rt as generateUtilityClass, Tt as init_DefaultPropsProvider, Ut as init_composeClasses, V as init_createTheme, Wt as composeClasses, X as init_cssGrid, Xt as capitalize, Y as init_palette, Yt as init_capitalize, Z as init_borders, an as isPlainObject, dt as init_styled_engine, ft as internal_processStyles, gt as GlobalStyles$1, it as init_style, jt as init_clamp, kt as clsx, mt as styled$1, nn as init_deepmerge, nt as init_spacing, ot as init_breakpoints, pt as internal_serializeStyles, rn as deepmerge, ut as init_createBreakpoints, z as extendSxProp } from "./styled-ViFiq-Ug.js";
import { Ht as init_exactProp$1, Ut as exactProp, ct as useId, dt as useEnhancedEffect, lt as init_useEnhancedEffect, ot as init_useId, t as init_esm } from "./esm-DuApuYGh.js";
...
import { t as toPropertyKey } from "./toPropertyKey-Cc3U6LiJ.js";
...
var _excluded$5 = ["className", "component"];
function createBox(options = {}) {
	...
	return /* @__PURE__ */ import_react.forwardRef(function Box(inProps, ref) {
		...
		const _extendSxProp = extendSxProp(inProps), { className, component = "div" } = _extendSxProp, other = _objectWithoutPropertiesLoose(_extendSxProp, _excluded$5);
...
init_createTheme();
init_styleFunctionSx();
var _excluded$4 = ["ownerState"], _excluded2 = ["variants"], _excluded3 = [
	"name",
	"slot",
...
function processStyleArg(callableStyle, _ref, layerName) {
	let { ownerState } = _ref, props = _objectWithoutPropertiesLoose(_ref, _excluded$4);
	...
	if (!!resolvedStylesArg && typeof resolvedStylesArg === "object" && Array.isArray(resolvedStylesArg.variants)) {
		...
		let result = _objectWithoutPropertiesLoose(resolvedStylesArg, _excluded2);
...
function RtlProvider(_ref) {
	let { value } = _ref, props = _objectWithoutPropertiesLoose(_ref, _excluded$3);
...
function createCssVarsProvider(options) {
	...
	function CssVarsProvider(props) {
		...
		const _ref = scopedTheme || themeProp, { colorSchemes = {}, components = {}, generateCssVars = () => ({
			vars: {},
			css: {}
		}), cssVarPrefix } = _ref, restThemeProp = _objectWithoutPropertiesLoose(_ref, _excluded$2);
		...
		] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ThemeProvider, {
...
function prepareCssVars(theme, parserConfig) {
	...
	const { vars: rootVars, css: rootCss, varsWithDefaults: rootVarsWithDefaults } = cssVarsParser(_objectWithoutPropertiesLoose(theme, _excluded$1), parserConfig);
...
function createContainer(options = {}) {
	...
	const Container = /* @__PURE__ */ import_react.forwardRef(function Container(inProps, ref) {
		...
		const { className, component = "div", disableGutters = false, fixed = false, maxWidth = "lg" } = props, other = _objectWithoutPropertiesLoose(props, _excluded);
...
init_spacing();
//#endregion
export { GlobalStyles as C, createBox as S, useTheme$2 as T, rgbToHex as _, ThemeProvider as a, styled as b, darken as c, getContrastRatio as d, getLuminance as f, recomposeColor as g, lighten as h, createCssVarsProvider as i, decomposeColor as l, hslToRgb as m, prepareCssVars as n, useRtl as o, hexToRgb as p, createGetCssVar as r, alpha as s, createContainer as t, emphasize as u, useThemeProps as v, useTheme$1 as w, shouldForwardProp as x, getThemeProps as y };

//# sourceMappingURL=esm-IXmzNn18.js.map