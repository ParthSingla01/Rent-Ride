...
import { $ as init_createSpacing, F as require_colorManipulator, G as styleFunctionSx, K as defaultSxConfig, L as init_createMixins, Q as createSpacing, R as init_styleFunctionSx, _ as createTypography, c as init_identifier, f as createTheme, g as init_createTransitions, l as defaultTheme, lt as createBreakpoints, nn as init_deepmerge, p as init_createTheme, rn as deepmerge, s as identifier_default, t as init_styled, u as init_defaultTheme, ut as init_createBreakpoints, v as init_createTypography } from "./styled-ViFiq-Ug.js";
...
import { a as ThemeProvider$1, i as createCssVarsProvider, n as prepareCssVars, r as createGetCssVar$1, v as useThemeProps$1 } from "./esm-IXmzNn18.js";
import { t as getOverlayAlpha } from "./getOverlayAlpha-DWqt0Hvk.js";
...
function extendTheme(options = {}, ...args) {
	...
	const _createThemeWithoutVa = createTheme(_extends({}, input, colorSchemesInput.light && { palette: (_colorSchemesInput$li = colorSchemesInput.light) == null ? void 0 : _colorSchemesInput$li.palette })), { palette: lightPalette } = _createThemeWithoutVa, muiTheme = _objectWithoutPropertiesLoose(_createThemeWithoutVa, _excluded2);
	const { palette: darkPalette } = createTheme({ palette: _extends({ mode: "dark" }, (_colorSchemesInput$da = colorSchemesInput.dark) == null ? void 0 : _colorSchemesInput$da.palette) });
...
//#endregion
export { createMuiStrictModeTheme as _, excludeVariablesFromRoot as a, withTheme as c, ThemeProvider as d, useThemeProps as f, createStyles as g, toUnitless as h, useColorScheme as i, withStyles as l, getUnit as m, CssVarsProvider as n, extendTheme as o, responsiveFontSizes as p, getInitColorSchemeScript as r, shouldSkipGeneratingVar as s, experimental_sx as t, makeStyles as u, adaptV4Theme as v };

//# sourceMappingURL=styles-DHpY1t1m.js.map