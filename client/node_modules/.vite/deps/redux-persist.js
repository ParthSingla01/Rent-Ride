import { i as combineReducers } from "./redux-Couub0BQ.js";
import { a as PAUSE, c as REGISTER, i as KEY_PREFIX, l as REHYDRATE, n as DEFAULT_VERSION, o as PERSIST, r as FLUSH, s as PURGE, t as persistStore } from "./persistStore-D2AN8-Nn.js";
...
//#endregion
//#region node_modules/redux-persist/es/stateReconciler/autoMergeLevel2.js
...
//#endregion
//#region node_modules/redux-persist/es/persistCombineReducers.js
function persistCombineReducers(config, reducers) {
	config.stateReconciler = config.stateReconciler === void 0 ? autoMergeLevel2 : config.stateReconciler;
	return persistReducer(config, combineReducers(reducers));
}
//#endregion
//#region node_modules/redux-persist/es/createMigrate.js
function createMigrate(migrations, config) {
	...
	return function(state, currentVersion) {
		...
		var inboundVersion = state._persist && state._persist.version !== void 0 ? state._persist.version : -1;
...
//#endregion
//#region node_modules/redux-persist/es/createTransform.js
...
//#endregion
export { DEFAULT_VERSION, FLUSH, KEY_PREFIX, PAUSE, PERSIST, PURGE, REGISTER, REHYDRATE, createMigrate, createPersistoid, createTransform, getStoredState, persistCombineReducers, persistReducer, persistStore, purgeStoredState };
